"""
Модуль save_manager.py - управление сохранением прогресса игрока
Отвечает за загрузку, сохранение и обновление данных игрока в JSON файле.
Хранит информацию о монетах, рекорде, разблокированных башнях.
"""
import json
import os
